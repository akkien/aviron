...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_race.listOpenRacesResponse"
                        }
                    },
                    "401": {
                        "description": "error: unauthorized",
    ...
    "definitions": {
        ...
        "internal_race.listOpenRacesResponse": {
            "type": "object",
            "properties": {
                "races": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_race.openRaceResponse"
                    }
                }
            }
        },
        "internal_race.openRaceResponse": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
